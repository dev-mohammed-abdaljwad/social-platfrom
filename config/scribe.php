...
return [
    ...
    'title' => 'Social Platform API Documentation',

    // A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
    'description' => 'RESTful API for Social Platform - A social networking application with user authentication, posts, comments, likes, and friendships.',
    ...
    'auth' => [
        ...
        'extra_info' => 'Authenticate by sending a Bearer token in the Authorization header. Get your token by calling the <b>Login</b> or <b>Register</b> endpoint.',
    ],
