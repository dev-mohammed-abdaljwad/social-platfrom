                ...
                <div class="flex-1">
                    ...
                    <div class="flex items-center gap-6 mt-4 pt-4 border-t border-gray-100">
                        <div class="flex items-center gap-1">
                            <button class="flex items-center gap-2 text-gray-600 hover:text-red-500 transition-colors like-btn {{ $post->is_liked ? 'text-red-500' : '' }}" data-post-id="{{ $post->id }}">
                        ...
                        <button class="flex items-center gap-2 text-gray-600 hover:text-green-500 transition-colors share-btn {{ $post->is_shared ? 'text-green-500' : '' }}" data-post-id="{{ $post->id }}">
                            <svg class="w-5 h-5" fill="{{ $post->is_shared ? 'currentColor' : 'none' }}" stroke="currentColor" viewBox="0 0 24 24">
