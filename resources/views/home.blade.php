                    ...
                    <div class="flex flex-wrap gap-3 mt-3">
                        <div class="flex-1 min-w-[200px]">
                            <div class="relative">
                                ...
                                <input type="text" name="location" placeholder="Add location (optional)" class="w-full pl-10 pr-4 py-2 bg-gray-100 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
                            </div>
                        </div>
                        <div class="min-w-[150px]">
                            <div class="relative">
                                ...
                                <select name="privacy" class="w-full pl-10 pr-8 py-2 bg-gray-100 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 appearance-none cursor-pointer">
        ...
        <div class="bg-white rounded-xl shadow-xl max-w-lg w-full mx-4 overflow-hidden">
            ...
            <form id="editPostForm" class="p-6">
                ...
                <div class="mb-4">
                    ...
                    <textarea id="editPostContent" rows="4" class="w-full px-4 py-3 bg-gray-100 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none" placeholder="What's on your mind?"></textarea>
                </div>
                <div class="mb-4">
                    <label class="block text-sm font-medium text-gray-700 mb-2">Location</label>
                    <input type="text" id="editPostLocation" class="w-full px-4 py-2 bg-gray-100 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Add location (optional)">
                </div>
                <div class="mb-4">
            ...
            <div class="flex justify-end gap-3 px-6 py-4 bg-gray-50 border-t border-gray-200">
                <button onclick="closeEditPostModal()" class="px-4 py-2 text-gray-600 hover:bg-gray-100 rounded-lg transition-colors font-medium">Cancel</button>
                <button onclick="saveEditPost()" class="px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors font-medium">Save Changes</button>
            </div>
        </div>
    </div>
    ...
    <div id="deleteModal" class="fixed inset-0 bg-black bg-opacity-50 hidden z-50 flex items-center justify-center">
        <div class="bg-white rounded-xl shadow-xl max-w-sm w-full mx-4 overflow-hidden">
            <div class="p-6 text-center">
                ...
                <h3 class="text-lg font-semibold text-gray-800 mb-2">Delete Post?</h3>
            ...
            <div class="flex border-t border-gray-200">
                <button onclick="closeDeleteModal()" class="flex-1 px-4 py-3 text-gray-600 hover:bg-gray-50 transition-colors font-medium">Cancel</button>
                <button onclick="confirmDelete()" class="flex-1 px-4 py-3 text-red-600 hover:bg-red-50 transition-colors font-medium border-l border-gray-200">Delete</button>
            </div>
        </div>
    </div>
@endsection
